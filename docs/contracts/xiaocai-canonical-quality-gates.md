...
> 当前 domain-pack source/path 以 `docs/contracts/xiaocai-domain-pack-source-contract.md` 为准。legacy domain-pack 目录已删除；当前质量门禁只以 `domain-packs/xiaocai/` 为 source of truth。
...
- xiaocai 字段表：`domain-packs/xiaocai/fields.yaml`
- 字段数量：81
...
- `domain-packs/xiaocai/fields.yaml#field_aliases`
...
- xiaocai 品类目录：`domain-packs/xiaocai/taxonomy.yaml`
- 采购负责类数量：10
- 一级品类数量：45
- 二级品类数量：96
...
- `domain-packs/xiaocai/taxonomy.yaml#field_matrix_defaults`
...
| 品类合法性 | 品类字段命中 `domain-packs/xiaocai/taxonomy.yaml` |
...
1. 字段字典：`domain-packs/xiaocai/fields.yaml`
2. 品类目录：`domain-packs/xiaocai/taxonomy.yaml`
3. 场景 fixture：`FLARE canonical regression fixtures / tests/domain_packs/test_xiaocai_pack.py`
...
- `domain-packs/xiaocai/templates/analysis.md + domain-packs/xiaocai/workflow.yaml#artifact_templates`
...
- `domain-packs/xiaocai/templates/sourcing-analysis.md + domain-packs/xiaocai/workflow.yaml#artifact_templates`
...
- `FLARE canonical regression fixtures / tests/domain_packs/test_xiaocai_pack.py`

## 10. 最小验收命令

```bash
python3 scripts/validate_domain_packs.py --root domain-packs
./.venv/bin/pytest adapters/http_api/tests/test_chat_prior_context.py adapters/http_api/tests/test_chat_stream_projection.py tests/domain_packs -q
