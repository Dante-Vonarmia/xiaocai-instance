...
ssh "$REMOTE_HOST" "REPO_DIR='$REMOTE_DIR' FRONTEND_API_BASE_URL='$FRONTEND_API_BASE_URL' API_UPSTREAM_URL='$API_UPSTREAM_URL' SERVER_NAME='$SERVER_NAME' bash '$REMOTE_DIR/deploy/scripts/remote-deploy-frontend-standalone.sh'"
